...
$('.p-chat-user').toggle('slide',options,500);$('.showChat').css('display','block');});
...
}); $(document).ready(function () { $(".theme-loader").animate({ opacity: "0" }, 1000); setTimeout(function () { $(".theme-loader").remove(); }, 1000); });
...
function toggleFullScreen() {
    ...
    if (!document.fullscreenElement && !document.mozFullScreenElement && !document.webkitFullscreenElement)
    {
        ...
        //Nuovo, aggiunto per IE ed Edge poi eslcuso per problemi di visualizzazione
...
'<a href="javascript:void(0)" id="finestraDimensioniCubo" class="waves-effect waves-light"></a>'+
'</div>' +
    //'<h5 class="font-header">Selezione campi</h5>' +
    //'<div id="configurator" class="hidden-on-narrow"></div>' +  

    //'<div class="p-15"><input type="button" class="btn btn-default" id="salvaImpostazioni" value="S A L V A"/></div>' +
